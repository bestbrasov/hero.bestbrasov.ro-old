...
?>
               ...
               <table class="table responsive">
                    ...
                    <tbody>
                        <tr>
                            <td><a href="mailto: bvb@BEST-eu.org">bvb@BEST-eu.org</a></td>
                            <td>Toti membrii LBG-ului</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bva@BEST-eu.org">bva@BEST-eu.org</a></td>
                            <td>Toti membrii activi</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-mdv@googlegroups.com">bv-mdv@googlegroups.com</a></td>
                            <td>Toti membrii cu drept de vot</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-management@googlegroups.com">bv-management@googlegroups.com</a></td>
                            <td>Toti membrii din management</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-board@BEST-eu.org">bv-board@BEST.eu.org</a></td>
                            <td>Toti membrii din board</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-alumni@BEST-eu.org">bv-alumni@BEST-eu.org</a></td>
                            <td>Toti membrii alumni</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-former@googlegroups.com">bv-former@googlegroups.com</a></td>
                            <td>Toti membrii former</td>
                        </tr>
                        <tr>
                            <td><a href="mailto: bv-fr@googlegroups.com">bv-fr@googlegroups.com</a></td>
                            <td>Departamentul FR</td>
                        </tr>
                        <tr>
                            <td><a href="mailto:bv-it@googlegroups.com">bv-it@googlegroups.com</a></td>
                            <td>Departamentul IT</td>
                        </tr>
                        <tr>
                            <td><a href="mailto:bv-hr@googlegroups.com">bv-hr@googlegroups.com</a></td>
                            <td>Departamentul HR</td>
                        </tr>
                        <tr>
                            <td><a href="mailto:bv-mkt@googlegroups.com">bv-mkt@googlegroups.com</a></td>
...
<!--						    <span class="iconfa-user"></span> <a href="dashboard.php?pagina=sediu">E cineva in sediu?</a><br />-->
                            ...
                            <span class="iconfa-user"></span> <a href="dashboard.php?pagina=frozen">FRozen</a><br />
						</div>

						<h4 class="widgettitle"><span class="iconfa-book"></span> Arhivele noastre</h4>
						<div class="widgetcontent">
						    <span class="iconfa-folder-open"></span> <a href="https://drive.google.com/drive/u/0/folders/1tGufC6zUq07YG7RbFZ0H8RKobvxmdRxt" target="_blank">Arhiva generala</a><br />
                            ...
                            <span class="iconfa-folder-open"></span> <a href="https://drive.google.com/drive/u/0/folders/1mpFBrvk4ONtdiDS-6Fs7s42Mh5XqMt-Z" target="_blank">Arhiva departamentului HR</a><br />
						</div>
