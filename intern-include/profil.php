...
}elseif($_SESSION['intern-acces'] == 3)
{
	...
	{
		ban_user($_GET['id']);
	}elseif(isset($_GET['unban']) && $_GET['unban']=="true")
	{
		unban_user($_GET['id']);
	}
?>           <form method="post" class="searchbar">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
               ...
               <h4 class="widgettitle">Activitate</h4>
			    ...
			    <p>
                                <label>Sedinte (<?php echo (int) count_meetings_for_user($_GET['id']); ?>) <?php if($_SESSION['intern-acces'] >= 2) { ?><a href="dashboard.php?utilizator=<?php echo (int) $_GET['id']; ?>&pagina=modsedinte"><span class="iconfa-pencil"></span></a><?php } ?></label>
                                <span class="field">
