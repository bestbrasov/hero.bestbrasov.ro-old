...
?>       <div class="pageheader">
            ...
            <div class="pagetitle">
                <h5>Anunta un proiect nou</h5>
                <h1>Anunta proiect nou</h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
			...
			{
				echo add_project($_POST['csrf'],$_POST['nume'],$_POST['descriere'],$_POST['datai'],$_POST['dataf'],$_POST['categorie']);
			}
			?>
                <h4 class="widgettitle">Anunta proiect nou</h4>
