...
{
?>
		<?php if(isset($_POST['go2']) && $_POST['go2'] == "y") {
            echo admin_save_access($_POST['csrf'],$_GET['utilizator'],$_POST['statut'],$_POST['acces']);$data = get_user_data($_GET['utilizator']);
        } ?>
...
<?php
			...
			if(isset($_POST['go3']) && $_POST['go3']=="y")
...
?>
		...
		<?php if(isset($_POST['go']) && $_POST['go']=="y"){
            echo admin_save_user_settings($_GET['utilizator'],$_POST['telefon'],$_POST['datanasterii'],$_POST['databest'],$_POST['generatie'],$_POST['csrf']);$data = get_user_data($_GET['utilizator']);
        } ?>
