       <div class="pageheader">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
				...
				<?php if(isset($_POST['submit']) && $_POST['submit']=="y")
                {
                    echo save_settings_data($_POST['telefon'],$_POST['datanasterii'], $_POST['csrf']);
                } ?>
				...
				<div id="dashboard-left" class="col-md-6">
				<?php if(isset($_POST['submit2']) && $_POST['submit2']=="y")
                {
                    echo save_best_settings_data($_POST['databest'],$_POST['generatie'],$_POST['csrf']);
                } ?>
