...
<div class="pageicon"><span class="iconfa-cogs"></span></div>
        ...
        <div class="maincontent">
            ...
            if (isset($_POST['go']) && $_POST['go'] == "y") {
                $message = add_auth_email($_POST['csrf'], $_POST['emails']);
                $emails = get_auth_emails();
                ...
                <div class="widgetcontent nopadding">
                    <form class="stdform stdform2" method="post" action="">
                            <p>
                                ...
                                <span class="field">
                                    <label for="tagss"></label><input name="emails" id="tagss" value="<?php echo htmlspecialchars(implode(",", $emails), ENT_QUOTES); ?>">
                                </span>
                            </p>
