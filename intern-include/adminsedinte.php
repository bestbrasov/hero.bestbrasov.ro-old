...
<div class="pageheader">
    ...
    <div class="pagetitle">
        <h5>Categoriile pentru sedinte</h5>
        <h1>Administrare categorii de sedinte</h1>
    </div>
</div><!--pageheader-->
...
<div class="maincontent">
    <div class="maincontentinner">
        <?php
        if (isset($_GET['edit']) && check_catmeeting_exists($_GET['edit'])) {
            $info = get_catmeeting($_GET['edit']);
            if (isset($_POST['go']) && $_POST['go'] == "y") {
                $message = edit_catmeeting($_POST['csrf'], $_GET['edit'], $_POST['name']);
                echo "<div class='alert alert-success'>$message</div>";
                $info = get_catmeeting($_GET['edit']); // Actualizează informațiile după editare
            }
            ?>
            <div class="widgetbox">
            ...
            if (isset($_POST['go']) && $_POST['go'] == "y") {
                $message = add_catmeeting($_POST['csrf'], $_POST['name']);
                echo "<div class='alert alert-success'>$message</div>";
            }
            ?>
            <div class="widgetbox">
                    ...
                    <div class="col-md-3">
                        <div class="peoplewrapper" style="height:80px;">
                            <div class="peopleinfo" style="margin-left:0;">
                                ...
                                <ul>
                                    <li><a href="dashboard.php?pagina=adminsedinte&edit=<?php echo $categorie['ID']; ?>">Editeaza</a> | <a href="dashboard.php?pagina=adminsedinte&del=<?php echo $categorie['ID']; ?>">Sterge</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
